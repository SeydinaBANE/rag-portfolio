...
JUDGE_PROMPT = ChatPromptTemplate.from_messages([
    ("system", "You are a strict evaluator. Rate the answer on a scale from 0 to 1 based on how well it answers the question using the provided context. Respond with ONLY a number between 0 and 1."),
